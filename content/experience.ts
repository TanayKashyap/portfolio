export interface Experience {
  ...
  bullets: string[];
  /** Skill / technique chips rendered under each role. */
  metrics: string[];
}
...
export const experience: Experience[] = [
  {
    ...
    metrics: ["time-series forecasting", "clustering", "causal inference"],
  },
  {
    ...
    metrics: ["A/B testing", "TensorFlow", "BERT NER"],
  },
  {
    company: "Royal Bank of Canada (RBC)",
    ...
    metrics: ["Tableau", "Airflow", "Monte Carlo"],
  },
  {
    ...
    metrics: ["autoencoders", "GANs", "homomorphic encryption"],
  },
];