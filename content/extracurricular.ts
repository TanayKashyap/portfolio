...
export const extracurricular: Extracurricular[] = [
  {
    ...
    bullets: [
      "Developing a novel word cloud method combining statistical term validation, temporal frequency evolution, and semantic embeddings to create richer topic visualizations that help researchers interpret language shifts in large text datasets.",
